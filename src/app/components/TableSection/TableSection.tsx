...
export default function TableSection() {
  return (
    <section className="flex justify-center w-full font-montserrat  bg-white px-[8px] bigPhone:px-[30px] hd:px-0 py-[45px]">
      <div className="w-[1200px]">
        <h2 className="font-semibold text-fontMain text-[36px]  leading-[40px] mb-[45px] ">
