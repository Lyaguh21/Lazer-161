...
import EquipmentBlock from "../../EquipmentSection/EquipmentBlock";
import React from "react";
export default function LazerModal() {
  return (
    <DialogContent>
      <DialogHeader>
      ...
      <DialogTitle className="flex flex-col gap-4">
        ...
        <div className="w-full gap-3 flex bg-gray p-3 justify-center bigPhone:justify-start flex-wrap">
          <img
            src="\img\EquipmentSection\SENFENG.svg"
            alt=""
